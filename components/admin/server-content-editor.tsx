...
export default function ServerContentEditor() {
    ...
    return (
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="flex items-center justify-center">
          ...
          <span className="ml-2 text-lg">Loading content from server...</span>
        </div>
      </div>
    )
  }
    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          ✅ Changes are automatically saved to the server and visible on ALL devices instantly!
        </p>
      </div>

      {saved && (
        <Alert className="mb-6">
          <AlertDescription>✅ Content saved to server! Changes are now live on ALL devices.</AlertDescription>
        </Alert>
      )}
